        ...
        <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
          <ul class="navbar-nav">
            <li class="nav-item active">
              <a class="nav-link" href="{{url('/home?view=Home')}}">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('home?view=Aspirasi')}}">Aspirasi</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{url('/home?view=About')}}"> About</a>
            </li>
          </ul>
        </div>
